...
const dummyCredentials = {
  admin: { email: "admin1@gmail.com", password: "admin1@gmail.com" },
  teacher: { email: "rahman11@gmail.com", password: "rahman11@gmail.com" },
  student: { email: "samir1@gmail.com", password: "samir1@gmail.com" },
  guardian: { email: "rumana1@gmail.com", password: "rumana1@gmail.com" },
};
...
const Login = () => {
  ...
  const handleRoleSelect = (role) => {
    ...
    setValue("email", dummyCredentials[role].email);
    setValue("password", dummyCredentials[role].password);
  };
  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-md bg-[var(--card-bg)] p-6 rounded-lg shadow">
        ...
        {/* Dummy Role Selector */}
        <div className="mb-4">
          <p className="text-sm text-[var(--text-secondary)] mb-2">Quick login (demo):</p>
          <div className="grid grid-cols-2 gap-2">
            {Object.keys(dummyCredentials).map((role) => (
              <button
                key={role}
                type="button"
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full border border-[var(--border)] rounded px-3 py-2 bg-[var(--bg)] text-[var(--text-primary)]"
            />
            {errors.email && <p className="text-red-500 text-sm mt-1">{errors.email.message}</p>}
          </div>
