...
//             <p className="text-xl sm:text-2xl font-bold text-text-primary">
//               {students.filter((s) => s.tuitionStatus === "active").length}
//             </p>
//           </div>
//         </div>
...
//             <p className="text-xl sm:text-2xl font-bold text-text-primary">
//               {students.filter((s) => s.tuitionStatus === "pending").length}
//             </p>
//           </div>
//         </div>
...
//               <tr>
//                 <th className="px-3 sm:px-6 py-2 sm:py-3 text-left text-xs sm:text-sm font-medium text-text-secondary">
//                   Name
//                 </th>
//                 <th className="px-3 sm:px-6 py-2 sm:py-3 text-left text-xs sm:text-sm font-medium text-text-secondary">
//                   Grade
...
//                   <td
//                     colSpan="7"
//                     className="px-3 sm:px-6 py-6 sm:py-8 text-center text-text-secondary text-sm sm:text-base"
//                   >
//                     No students found.
//                   </td>
//                 </tr>
...
//                   <tr
//                     key={student.id}
//                     className="border-t border-border hover:bg-hover-bg"
//                   >
...
//                         <button
//                           onClick={() =>
//                             navigate(`/guardian/students/${student.id}/progress`)
//                           }
...
//                         <button
//                           onClick={() =>
//                             navigate(`/guardian/students/${student.id}/tuition`)
//                           }
